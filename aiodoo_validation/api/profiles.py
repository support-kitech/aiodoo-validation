...
from aiodoo_validation.domain.enums import ExecutionTier, OdooVersion, ValidationStage
...
def get_profile_info(profile_name: str) -> ProfileInfo:
    ...
    return ProfileInfo(
        ...
        supported_odoo_versions=(OdooVersion.V17, OdooVersion.V18, OdooVersion.V19),
