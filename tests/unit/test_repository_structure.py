...
REQUIRED_DIRS = [
    ...
    "aiodoo_validation/capabilities/approval",
    "aiodoo_validation/capabilities/coding",
    "aiodoo_validation/capabilities/conversation",
    "aiodoo_validation/capabilities/evaluation",
    "aiodoo_validation/capabilities/execution",
    "aiodoo_validation/capabilities/planner",
...
REQUIRED_FILES = [
    ...
    "aiodoo_validation/capabilities/approval/capability.yaml",
    "aiodoo_validation/capabilities/coding/capability.yaml",
    "aiodoo_validation/capabilities/conversation/capability.yaml",
    "aiodoo_validation/capabilities/evaluation/capability.yaml",
    "aiodoo_validation/capabilities/execution/capability.yaml",
    "aiodoo_validation/capabilities/planner/capability.yaml",
    "aiodoo_validation/capabilities/repair/capability.yaml",
    "docs/approval_profile.md",
    "docs/coding_profile.md",
    "docs/conversation_profile.md",
    "docs/evaluation_profile.md",
    "docs/execution_profile.md",
    "docs/planner_profile.md",
    "docs/repair_profile.md",
